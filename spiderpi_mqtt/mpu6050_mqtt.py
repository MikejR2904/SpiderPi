...
class mpu6050:
    ...
    def get_all_data(self):
        ...
        msg = {'accel':accel, 'gyro':gyro}
        json_data = json.dumps(msg)
        
        # Publish combined data to MQTT topic '/imu/raw'
        self.mqtt_client.publish("/imu/raw", json_data)
...
if __name__ == "__main__":
    ...
    mpu.mqtt_client.loop_start()  # Start the MQTT client loop
    while True:
        try:
            ...
            print('error: ', e)
    mpu.mqtt_client.loop_stop()  # Stop the MQTT client loop before exiting
