...
Modified by: David Michael Indraputra
Modification description: Costumized to ROS2 environment
    ...
    def read_i2c_word(self, register, retries = 5):
        ...
        for attempt in range(retries):
        	try:
        		...
        		self.get_logger().info(f"I2C read failed in attempt {attempt + 1}")
        		time.sleep(0.01)
        
        self.get_logger.error("Max retries reached. I2C read failed.")
        return None
